print "How many euro will you give me in exchange for one sterling pound, dude? ";
double euroOverPoundRatio = Double.parseDouble(System.console().readLine());
print "How many sterling pounds will you give me in exchange for one euro, hombre? ";
